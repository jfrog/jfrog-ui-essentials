<template>
    ...
    <div><span class="clip-copy-button">
        <a v-show="!isSafari && !!textToCopy" class="copy-to-clip icon icon-copy-to-clipboard-2" :data-clipboard-text="textToCopy" v-jf-tooltip.bind="tooltipText"></a>
        <a v-show="isSafari && !!textToCopy" class="copy-to-clip icon icon-copy-to-clipboard" v-clip-copy="'textToCopy'" clip-click="onSuccessfulCopy()" v-jf-tooltip.bind="tooltipText"></a>
    </span>
