            ...
            <div class="row">
                <div class="col-lg-5 col-md-5 col-sm-5">
                    ...
                    <div :id="excludeListId" class="dnd-list-wrapper" @mouseenter="mouseIsInExclude(true)" @mouseleave="mouseIsInExclude(false)">
                        <ul class="dnd-list">
                            <li v-for="(item, $index) in getViewableExcludes()" class="drag-item" :class="{'drag-placeholder':item===PLACEHOLDER, 'active' : isSelected(item)}" :data-index="'exc-' + $index" @click="toggleSelection(item)" ng-dblclick="includeSpecific(item)" @mouseenter="mouseOver(item)" @mouseleave="mouseOver(null)">
                ...
                <div class="col-lg-5 col-md-5 col-sm-5">
                    ...
                    <div :id="includeListId" class="dnd-list-wrapper" @mouseenter="mouseIsInInclude(true)" @mouseleave="mouseIsInInclude(false)">
                        <ul class="dnd-list dnd-list-fullheight">
                            <li v-for="(item, $index) in getViewableIncludes()" class="drag-item dropped-item" :class="{'drag-placeholder':item===PLACEHOLDER, 'active' : isSelected(item)}" :data-index="'inc-' + $index" @click="!$event.defaultPrevented ? (toggleSelection(item)) : ''" ng-dblclick="excludeSpecific(item)" @mouseenter="mouseOver(item)" @mouseleave="mouseOver(null)">
                                <div class="drag-item-text" v-if="item !== PLACEHOLDER && !customTemplate">
                                    <i v-if="item._iconClass" :class="item._iconClass"></i>
