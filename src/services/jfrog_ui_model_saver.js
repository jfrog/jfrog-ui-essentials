...
export function JFrogUIModelSaverFactory($timeout, JFrogModal, $q) {
	return {
		get confirmDiscardModalOpen() {return JFrogUIModelSaverFactory.prototype.confirmDiscardModalOpen},
