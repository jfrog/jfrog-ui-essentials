export class JFrogNotifications {
    ...
    create(message, allowHtml = false) {
        if (message.info) {
            ...
            this.$set(this, 'lastNotification', message.info);
            this.$timeout(() => {
                this.$set(this, 'lastNotification', null);
            }, message.timeout || 5000);    //this.toast.create({animation:'fade',content:message.info});
        }
        if (message.error) {
            ...
            this.$set(this, 'lastNotification', message.error);
            this.$timeout(() => {
                this.$set(this, 'lastNotification', null);
            }, message.timeout || 0);    //this.toast.danger({animation:'fade',content:message.error});
        }
        if (message.warn) {
            ...
            this.$set(this, 'lastNotification', message.warn);
            this.$timeout(() => {
                this.$set(this, 'lastNotification', null);
            }, message.timeout || 0);
        }
