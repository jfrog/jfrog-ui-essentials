...
/* harmony default export */ __webpack_exports__["default"] = ({
  bind: function bind(el, binding, vnode) {
    ...
    var patchedLinkFn = _plugins_JFrogUI_Ng1AttributeDirectiveAdapter__WEBPACK_IMPORTED_MODULE_0__[/* Ng1AttributeDirectiveAdapter */ "a"].patchLinkFunction(ng1LinkFunction.bind(this, opts), null);
    patchedLinkFn(el, binding, vnode);
  }
});

function ng1LinkFunction(_ref, $scope, $element, $attrs) {
  var shouldSanitize = _ref.shouldSanitize;
...
//# sourceMappingURL=jfrog-ui-essentials.common.JfTooltipOnOverflowDirective.js.map